...
/*
  ...
  Neste exemplo é feito o tratamento tanto do problema da divisão
  por zero, quanto de entradas inválidas (valores não inteiros),
  usando o mecanismo de tratamento de exceções do Java.
